...
-- Tao chi so cho productid
create index ProductID_view
on OrderItems (productid);

-- Tao view ProductRevenueSummary 
...
select products.productid as `ProductID`,
	...
	sum(orderitems.quantity*orderitems.price) as `TotalRevenue`
from 
    products
...
-- Truy van sp doanh thu > 10k va giam dan
